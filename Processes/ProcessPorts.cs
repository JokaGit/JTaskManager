        ...
        private static List<ProcessPort> GetNetStatPorts()
        {
            ...
            try
            {
                using (Process Proc = new Process())
                {
                    ...
                    {
                        MessageBox.Show("NetStat command failed.   This may require elevated permissions.");
                    }
                    ...
                    foreach (string NetStatRow in NetStatRows)
                    {
                        ...
                        if (Tokens.Length > 4 && (Tokens[1].Equals("UDP") || Tokens[1].Equals("TCP")))
                        {
                            ...
                            {
                                MessageBox.Show("Could not convert the following NetStat row to a Process to Port mapping.");
                            }
                        }
                    }
                }
